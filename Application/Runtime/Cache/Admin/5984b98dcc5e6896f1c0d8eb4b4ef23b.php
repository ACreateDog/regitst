            ...
            <div class="widget">
                ...
                <div class="widget-body">
                    ...
                    <div class="table-toolbar operation">
                        <div class="btn-group">
                            <a type="button" id="" class="btn btn-default" href="<?php echo U('Enter/civil_studnet_info_export');?>?type=4">
                    ...
                    <table class="table table-striped table-hover table-bordered" id="student_info">
                        ...
                        <tbody>
                            <?php if(is_array($data)): foreach($data as $k=>$vo): ?><tr>
                                    ...
                                    <td class="center ">
                                        <?php if(($vo["civil_status"] == 2) and ($vo["civil_release"] == 1)): ?>同意
                                            <?php elseif(($vo["civil_status"] == 3) and ($vo["civil_release"] == 1)): ?>拒绝
                                            <?php elseif(($vo["civil_status"] == 1) and ($vo["lot_release"] == 1)): ?>派中
                                            <?php elseif(($vo["civil_status"] == 4) and ($vo["lot_release"] == 1)): ?>未派中
                                            <?php elseif(($vo["lot_release"] == 0)): ?>等待摇号
