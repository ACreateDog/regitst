...
<head lang="en">
    ...
    <link href="/register_system/Public/Home/Register/css/register.css" rel="stylesheet" />
                ...
                <div class="widget">
                    ...
                    <div class="widget-body">
                        ...
                        <div class="mail-container" style="top:12px;">
                            <div class="mail-body" style="margin-left:0px;;">
                                <ul class="mail-list">
                                    <li class="list-item">
                                        <div class="item-sender" style="font-size: 20px;color: royalblue;">
                                            父亲信息
                                        </div>
                                    </li>
                                    <li class="list-item">
